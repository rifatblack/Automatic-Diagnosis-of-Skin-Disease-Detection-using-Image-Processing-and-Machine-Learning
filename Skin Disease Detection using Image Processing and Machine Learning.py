# -*- coding: utf-8 -*-
"""
Created on Wed Sep 14 00:04:39 2022
...
print(os.listdir("Skin Images/new"))

SIZE = 128

train_images = []
train_labels = [] 
for directory_path in glob.glob("Skin Images/new/*"):
...
test_images = []
test_labels = [] 
for directory_path in glob.glob("Skin Images/new test/*"):
